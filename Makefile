...
build:
	...
	@echo "Build complete! Image: target/x86_64-unknown-none/release/boot-bios-rust-os.img"
...
test: build
	...
	qemu-system-x86_64 -drive format=raw,file=target/x86_64-unknown-none/release/boot-bios-rust-os.img -display curses
